...
if grep -R -n -F -e "${{template_marker_one}}" -e "${{template_marker_two}}" -e "${{template_marker_three}}" AGENTS.md docs prompts README.md scripts >/tmp/{meta.slug}-harness-placeholders.txt; then
