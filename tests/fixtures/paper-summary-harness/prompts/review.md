# Review Prompt: Paper Summary Harness

## Purpose
Review the resulting harness against the specification, constraints, and verification evidence.

## Context
- Harness: Paper Summary Harness
